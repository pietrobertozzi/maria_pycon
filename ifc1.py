...
ifc1_help_list = [
    ...
    ('----- SELF TEST DINPUT           ', ''),
    #('mst.ms(\'testMcp2317 2 0 0 0\')  ', 'self test DIN DIO0'),
    #('mst.ms(\'testMcp2317 2 0 0 1\')  ', 'self test DIN DIO1'),
    #('mst.ms(\'testMax7300(5,0,0,0)\') ', 'self test DIN PIO0'),
    #('mst.ms(\'testMax7300(5,0,0,1)\') ', 'self test DIN PIO1'),
    ('', ''),
